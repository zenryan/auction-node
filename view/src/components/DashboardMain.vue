<template>
  <div class="container px-2 xl:px-6 mx-auto grid">
    ...
    <a
      class="flex items-center justify-between p-4 mb-8 text-sm
        font-semibold text-blue-100 bg-blue-600 rounded-lg shadow-md
    ...
    >
      ...
      <span>View github repo &RightArrow;</span>
    </a>
    <!-- Cards -->
    ...
    <CardSlider
      ...
      desc="Join the auctions to get the best stuff"
    />

    <CardSlider
      :items="upcomingAuctions"
      title="Upcoming auctions"
      desc="Come back when auction has started"
    />

    <CardSlider
      :items="expiredAuctions"
      title="Previous auctions"
      desc="See who is the lucky auction winner"
    />
  </div>
</template>
