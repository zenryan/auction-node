<template>
  ...
  >
        ...
        <ul class="mt-6">
          <li class="relative px-6 py-3">
            ...
            >
              ...
              <span class="ml-4">Dashboard sample</span>
            </a>
          </li>
        </ul>
        <ul>
    ...
    <!-- Mobile sidebar -->
    <!-- Backdrop -->
    <!-- x-transition remove for now, can reference github on the original value -->
    <div
        ...
        <div class="container px-6 mx-auto grid">
          ...
          >
            <div class="flex items-center">
              ...
              <span>Star this project on GitHub. https://github.com/estevanmaito/windmill-dashboard</span>
            </div>
