      ...
      <div class="px-4 mx-auto">
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center">
            <div
              class="justify-center hover:text-blue-500 hover:bg-blue-100 rounded-full p-2 text-center"
            >
              <svg
    ...
    <div class="flex">
      <div class="flex-col border-r mt-16 pl-5 w-1/5 bg-gray-100 h-auto">
        <div class="flex ml-3 py-8">
          <div class="h-8 w-8 rounded">
            <img
              class="h-8 w-12 mt-1 rounded "
              src="https://www.noeticitservices.com/images/hero-img05.png"
            />
          </div>
          <div class="flex-col">
            <div
              class="items-center cursor-pointer px-2  mb-1 text-sm font-medium text-gray-700 hover:underline"
            >
              Noetic IT Service
            </div>
        ...
        <div class=" px-3">
          <div class="flex py-2 px-4 cursor-pointer hover:bg-blue-100 rounded">
            ...
            <div
              class="ml-5 text-sm text-gray-600  font-normal antialiased tracking-normal"
            >
              Back to project
            </div>
          </div>
        ...
        <div class="overflow-auto" style="height: 430px">
          <div class="flex-col px-3">
            <div
              class="items-center ml-2 py-4  mb-1 text-sm font-medium text-gray-700"
            >
              Issues and filters
            </div>
            <div
              class="py-3 px-3 hover:bg-blue-100 cursor-pointer rounded text-sm text-gray-600  font-normal antialiased tracking-normal"
            >
              My open issues
            </div>
            <div
            ...
            <div
              class="py-3 px-3 bg-blue-100 cursor-pointer rounded text-sm text-gray-600  font-normal antialiased tracking-normal"
            >
              All issues
            </div>
            <div
            ...
            <div class="border border-gray-300 mt-5"></div>
            <div
              class="cursor-pointer py-3 px-3 mb-5 mt-5 hover:bg-blue-100 rounded text-sm text-gray-600  font-normal antialiased tracking-normal"
            >
              View all filters
            </div>
          </div>
      ...
      <div class="flex w-4/5 mt-24 h-auto">
        <div class=" ml-10 h-full" style="width: 400px">
          <div
            class="text-sm text-gray-600 font-normal antialiased tracking-normal"
          >
            Projects &nbsp; / &nbsp; Biltrax IT Project
          </div>
          <div
            class="text-2xl mt-3 text-black font-semibold antialiased tracking-normal"
          >
            All Issues
          </div>
          <div class="flex mt-5 w-full">
            ...
            />
            <div
              class="items-center cursor-pointer px-2  mb-1 text-sm text-blue-500 hover:underline"
            >
              Advanced search
            </div>
          </div>
          <div class="bg-gray-100 mt-4 rounded">
            <div class="flex  justify-between px-1 text-center items-center">
              <div
                class="flex px-3 py-1 self-center text-sm font-medium text-gray-800 antialiased rounded-md focus:outline-none hover:bg-blue-100 text-blue-500 focus:bg-blue-100"
              >
              ...
              <div class="p-2">
                <button
                  class="flex rounded px-4 py-2 focus:outline-none text-gray-500 hover:bg-blue-100 justify-around"
                >
                  <svg
                    class="h-3 w-3 "
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="mx-2 bg-white rounded">
              <div class="overflow-auto flex-col" style="height: 308px">
                <div class="flex-col cursor-pointer rounded hover:bg-blue-100">
                  <div
                    class="py-3 px-3 cursor-pointer text-gray-700 rounded text-sm font-normal antialiased tracking-normal"
                  >
                  ...
                  <div class="flex px-3 justify-between">
                    ...
                    <button
                      class="flex rounded-full p-1 pb-1 h-6 w-6 bg-orange-500 justify-around"
                    >
                ...
                <div class="flex-col cursor-pointer bg-blue-100">
                  ...
                  <div class="flex px-3 justify-between">
                    <div class="flex">
                      ...
                      <div
                        class="font-bold line-through text-gray-500 ml-1 text-xs"
                      >
                        NITSWEBAPP-02
                      </div>
                    </div>
            ...
            <div class="flex  justify-between px-1 text-center items-center">
              ...
              <div
                class="flex px-3 py-1 self-center text-sm antialiased rounded-md text-gray-600 "
              >
                issue 48 of 88
              </div>
            </div>
        ...
        <div class="w-full relative ml-10  pt-32">
          <div
            class="absolute hover:text-blue-500 mb-64 right-0 top-0 underline cursor-pointer mr-16 mt-5 text-sm text-gray-700  font-semibold antialiased tracking-normal"
          >
            Give feedback
          </div>

          <div
            class="flex w-full justify-between px-1 text-center items-center"
          >
            <div class="p-2 flex">
              <div
                class="py-3 cursor-pointer text-sm text-gray-600  font-normal antialiased tracking-normal"
              >
                NITSWEBAPP-49 /
              </div>
              <div class="flex ml-2 mt-3">
                ...
                <div
                  class="cursor-pointer ml-1 text-sm text-gray-600  font-normal antialiased tracking-normal"
                >
                  NITSWEBAPP-05
                </div>
              </div>
          ...
          <div class="flex overflow-auto" style="height: 350px">
            <div class="mr-10" style="width: 458px">
              <div
                class="w-full px-2 hover:bg-blue-100 py-2 text-2xl font-semibold"
              >
                Project & Company Slug
              </div>
              <div class="flex mt-1">
                <div
                  class="flex py-1 px-3 mr-2 cursor-pointer bg-gray-200 hover:bg-gray-300 rounded"
                >
                  <svg
                  ...
                  <div
                    class="ml-2 text-sm text-gray-700  font-normal antialiased tracking-normal"
                  >
                    Attach
                  </div>
                </div>
                ...
                <div
                  class="flex py-1 px-3 mr-1 cursor-pointer bg-gray-200 hover:bg-gray-300 rounded"
                >
                  <svg
                    class="h-5 w-5 text-gray-700"
                    fill="currentColor"
                ...
                <div
                  class="py-1 px-2 cursor-pointer bg-gray-200 hover:bg-gray-300 rounded"
                >
                  <svg
              ...
              <div
                class="items-center py-1 mt-5 mb-1 text-sm font-medium text-gray-800"
              >
                Description
              </div>
              <div class="flex-col p-2 rounded hover:bg-gray-200">
                <div class="flex">
                  ...
                  <div
                    class="text-sm ml-1 text-gray-800 antialiased tracking-normal font-normal "
                  >
              ...
              <div
                class="items-center py-1 mt-5 text-sm font-medium text-gray-800"
              >
                Environment
              </div>
              <div class="flex-col p-2 rounded hover:bg-gray-200">
              ...
              <div class="flex p-2 rounded">
                <div class="flex">
                  <div
                    class="text-sm ml-1 py-1 text-gray-800 antialiased tracking-normal font-normal "
                  >
                    Show :
                  </div>
                  <div
                    class="text-sm ml-2 py-1 cursor-pointer rounded px-2 text-white bg-gray-700 antialiased tracking-normal font-normal "
                  >
                    Comments
                  </div>
                  <div
                    class="text-sm ml-2 py-1 cursor-pointer rounded px-2 text-gray-800 bg-gray-200 antialiased tracking-normal font-normal "
                  >
                    History
                  </div>
                  <div
                    class="text-sm ml-2 py-1 cursor-pointer rounded px-2 text-gray-800 bg-gray-200 text-gray-800 antialiased tracking-normal font-normal "
                  >
                    Work Log
                  </div>
                </div>
              ...
              <div class="border mt-3"></div>
              <div
                class="items-center flex py-1 mt-5 text-sm font-medium text-gray-800"
              >
                <img
            ...
            <div class="bg-white rounded" style="width: 240px">
              <div class=" px-1 text-center items-center">
                <div
                  class="flex w-24 px-3 py-2 self-center text-sm font-medium antialiased rounded bg-blue-800 text-white"
                >
              ...
              <div class="mx-2 bg-white rounded">
                <div class="flex-col">
                  <div class="flex-col mt-3 rounded">
                    <div
                      class="py-1 px-1 text-gray-700 rounded text-xs font-semibold antialiased tracking-normal"
                    >
                      Assignee
                    </div>
                  ...
                  <div class="flex-col mt-3 rounded">
                    ...
                    <div class="flex px-2 py-2 hover:bg-gray-200">
                      <img
                        class="w-6 h-6 rounded-full"
                        src="https://www.noeticitservices.com/images/nitish.jpg"
                        alt=""
                      />
                      <div class="font-normal text-gray-700 ml-3 text-xs">
                        Nitish Kumar
                  ...
                  <div class="flex-col mt-3 rounded">
                    ...
                    <div class="flex px-1 py-2 hover:bg-gray-200">
                      <div
                        class="font-normal bg-purple-300 p-1 underline hover:bg-transparent rounded text-gray-700 ml-3 text-xs"
                      >
                        Nitseditor-frontend
                      </div>
                    </div>
                  ...
                  <div class="flex-col mt-3 rounded">
                    ...
                    <div class="px-2 py-2 hover:bg-gray-200">
                      <div
                        class="font-normal text-gray-700 hover:text-blue-500 hover:underline ml-3 text-xs"
                      >
                  ...
                  <div class="flex-col mt-3 rounded">
                    <div class="px-2 py-2 hover:bg-gray-200">
                      <div
                        class="flex self-center text-sm font-medium antialiased rounded text-blue-500"
                      >
                        <svg
                          class="h-4 w-4 mt-1 ml-1"
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <div
                        class="text-xs pl-3 font-light antialiased rounded text-gray-500"
                      >
              ...
              <div class="flex justify-between px-1 text-left ">
                <div
                  class="p-2 text-xs text-gray-600 antialiased tracking-normal"
                >
